...
mvn -Pibm-jdk8 -DskipTests=true -Dmaven.javadoc.skip=true -pl \!:joram-tests,\!:soak-tests,\!:stress-tests,\!:timing-tests,\!:performance-tests,\!:integration-tests,\!:jms-tests compile
